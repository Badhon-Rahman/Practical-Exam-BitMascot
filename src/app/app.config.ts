...
export class AppConfig {
  ...
  _resizeCallbacks = Array ;
  _screenSizeCallbacks = {
    xs: {enter: Array, exit: Array},
    sm: {enter: Array, exit: Array},
    md: {enter: Array, exit: Array},
    lg: {enter: Array, exit: Array},
    xl: {enter: Array, exit: Array}
  };
  ...
  onScreenSize(size : any, fn : any, /* Boolean= */ onEnter : boolean): void {
  ...
  changeColor(color: any, ratio: any, darker: any): string {
    const pad = function (num: any, totalChars: any): number {
      const padVal = '0';
      num = num + '';
